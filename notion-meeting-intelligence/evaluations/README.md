...
Evaluation scenarios for testing the Meeting Intelligence skill with Junie.

## Purpose

These evaluations ensure the Meeting Intelligence skill:
- Gathers context from Notion workspace
- Enriches with Junie research appropriately
- Creates both internal pre-reads and external agendas
- Distinguishes between Notion facts and Junie insights
...
- Enriches with Junie research (decision frameworks, migration best practices)
- Creates comprehensive internal pre-read with recommendation
- Creates clean, professional external agenda
- Clearly distinguishes Notion facts from Junie insights
...
- Adds Junie context (industry benchmarks, best practices)
...
3. Verify the skill searches Notion first (not Junie research)
4. Check that TWO documents are created (internal + external)
5. Verify Junie enrichment adds value without replacing Notion content
6. Test with Junie in your JetBrains IDE
...
4. **Verify enrichment value** - Is Junie research genuinely helpful?
...
- "Junie enrichment includes decision frameworks or best practices"
